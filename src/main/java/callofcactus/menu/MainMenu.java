...
public class MainMenu implements Screen {
	...
	public MainMenu(GameInitializer gameInitializer) {
		...
		TextButton newSinglePlayerButton = new TextButton("New singleplayer callofcactus", skin); // Use the initialized skin
		...
		TextButton newMultiPlayerButton = new TextButton("New multiplayer callofcactus", skin); // Use the initialized skin
