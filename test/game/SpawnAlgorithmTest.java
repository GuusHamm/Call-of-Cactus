...
public class SpawnAlgorithmTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        AICharacter aiCharacter = new AICharacter(game, new Vector2(5f, 5f), "AI1", new Sniper(), game.getPlayer(), null);
        AICharacter aiCharacter1 = new AICharacter(game, new Vector2(15f, 5f), "AI2", new Sniper(), game.getPlayer(), null);
        AICharacter aiCharacter2 = new AICharacter(game, new Vector2(25f, 5f), "AI3", new Sniper(), game.getPlayer(), null);
        AICharacter aiCharacter3 = new AICharacter(game, new Vector2(35f, 5f), "AI4", new Sniper(), game.getPlayer(), null);
        AICharacter aiCharacter4 = new AICharacter(game, new Vector2(45f, 5f), "AI5", new Sniper(), game.getPlayer(), null);
